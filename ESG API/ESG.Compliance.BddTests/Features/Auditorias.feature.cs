...
#line hidden
#line 24
    testRunner.And("o corpo deve conter os campos \"titulo, dataAgendada, auditorResponsavel, observac" +
                        "oes\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Criar auditoria e validar retorno no corpo")]
        [NUnit.Framework.CategoryAttribute("traceability")]
        [NUnit.Framework.CategoryAttribute("governanca")]
        public void CriarAuditoriaEValidarRetornoNoCorpo()
        {
            string[] tagsOfScenario = new string[] {
                    "traceability",
                    "governanca"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Criar auditoria e validar retorno no corpo", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 37
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
